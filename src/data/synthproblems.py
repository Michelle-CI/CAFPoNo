...
class NoiseOnly(NToOneModel):
    ...
    def __call__(
        ...
        return self._gamma_e * e + self._mu_e
...
class GaussianProcesses(object):
    def __init__(self, m, w1, w2, s: float) -> None:
...
class Sigmoidals(object):
    def __init__(self, m, w, a: float) -> None:
...
class PostNonlinearNToOne(NToOneModel):
    ...
    def __call__(self, x, e, adjust: bool = False):
...
class AutoGenCausalStructure(object):
    ...
    def generate_samples(self, e, adjust: bool = False):
